...
/****** Object:  StoredProcedure [dbo].[UP_RMD_DFts_Add_All_SE]    Script Date: 2017/2/9 上午 11:49:07 ******/
SET ANSI_NULLS ON
GO
...
--系統名稱      : Up_RMD_DFts_D
--程式性質　　: 副程式
--程式功能　　:產生RMD_DFts 資料 : 國內外期貨-風控分析資料Raw Data(自代操)整批區間產生
...
Begin
			...
			exec dbo.UP_RMD_DFts_Add_All_se
			  @i_ddate_w		   ,              
			  @i_ddate_w_s     ,
			  @i_level			   ,
			  @i_fund_Type     ,			  
...
*/
----------------------------------------------------------------------------------------------------
CREATE PRocedure [dbo].[UP_RMD_DFts_Add_All_SE]
