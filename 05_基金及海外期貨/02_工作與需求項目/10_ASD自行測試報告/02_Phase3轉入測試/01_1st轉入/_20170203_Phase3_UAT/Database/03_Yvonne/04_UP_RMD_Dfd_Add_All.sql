...
/****** Object:  StoredProcedure [dbo].[UP_RMD_Dfd_Add_All]    Script Date: 2017/2/9 上午 11:45:55 ******/
SET ANSI_NULLS ON
GO
...
--撰寫日期      : 2016-1228
--修改日期      : 2016-1228
--					  2017-0116 Yvonne Update for 基金沒有1akh & Zatg 這層, 所以傳入 01Z 等同於 1Z 
-----------------------------------------------------------------------------------------------------
/*
Use	     isdbTGL
Go
...
*/
----------------------------------------------------------------------------------------------------
Create PRocedure [dbo].[UP_RMD_Dfd_Add_All]
...
--Yvonne 2017-0116 基金沒有 1AKH,ZATG 這層, 所以這邊的01Z 等同於 1Z
			...
			And                ifund in (select ifund from dbo.fn_dfd where ddate_w = @i_ddate_w)						--只抓有產生庫存檔的
